...
function rvVitrine(){var A=[{i:'\ud83d\udcf8',l:'Revisar foto de mi plato',f:true,m:'Quiero que revises una foto de mi plato.'},{i:'\ud83d\udcdf',l:'Leer mi gluc\u00f3metro',f:true,m:'Quiero mostrarte la foto de mi gluc\u00f3metro o decirte mi n\u00famero.'},{i:'\ud83e\uddfe',l:'Revisar una etiqueta',f:true,m:'Quiero que revises la etiqueta de un producto.'},{i:'\ud83d\uded2',l:'Comer sano con poco dinero',f:false,m:'Quiero comer sano pero no me alcanza mucho. Ay\u00fadame con algo barato.'},{i:'\ud83e\uddb6',l:'Revisar un s\u00edntoma',f:false,m:'Quiero contarte un s\u00edntoma que estoy sintiendo.'},{i:'\ud83e\udde0',l:'Calmarme cuando tengo miedo',f:false,m:'Tengo miedo y quiero que me ayudes a calmarme.'},{i:'\ud83d\udc69\u200d\u2695\ufe0f',l:'Preparar mi consulta',f:false,m:'Ay\u00fadame a preparar mis dudas para mi pr\u00f3xima consulta m\u00e9dica.'},{i:'\ud83c\udf31',l:'Recordar mi avance',f:false,m:'Quiero recordar lo que ya hice y ver mi avance.'}];var cont=document.getElementById('lw-msgs');if(!cont)return;if(document.getElementById('lw-vitrine'))return;function disp(a){var inp=document.getElementById('lw-input');if(!inp)return;var pan=document.getElementById('lw-vit-panel');if(pan)pan.style.display='none';var bt=document.getElementById('lw-vit-toggle');if(bt)bt.setAttribute('data-open','0');inp.value=a.m;if(typeof enviar==='function')enviar(true);if(a.f){setTimeout(function(){var x=document.getElementById('lw-btn-anexo');if(x)x.click();},700);}}var box=document.createElement('div');box.id='lw-vitrine';box.style.cssText='margin:0 0 12px;padding:0 4px;';var toggle=document.createElement('button');toggle.id='lw-vit-toggle';toggle.type='button';toggle.setAttribute('data-open','0');toggle.textContent='\u00bfEn qu\u00e9 te ayudo?';toggle.style.cssText='display:block;width:100%;text-align:center;background:#fbf7ef;border:1px solid rgba(168,130,62,.4);border-radius:12px;padding:11px 14px;font-family:inherit;font-size:13.5px;font-weight:600;color:#b8543a;cursor:pointer;letter-spacing:.2px;';var panel=document.createElement('div');panel.id='lw-vit-panel';panel.style.cssText='display:none;margin-top:8px;';var grid=document.createElement('div');grid.style.cssText='display:grid;grid-template-columns:1fr 1fr;gap:8px;';A.forEach(function(a){var b=document.createElement('button');b.type='button';b.style.cssText='display:flex;align-items:center;gap:8px;text-align:left;background:#fbf7ef;border:1px solid rgba(168,130,62,.35);border-radius:12px;padding:11px 12px;font-family:inherit;font-size:12.5px;font-weight:600;color:#2b1810;cursor:pointer;line-height:1.25;';var s1=document.createElement('span');s1.style.cssText='font-size:17px;flex-shrink:0;';s1.textContent=a.i;var s2=document.createElement('span');s2.textContent=a.l;b.appendChild(s1);b.appendChild(s2);b.addEventListener('click',function(){disp(a);});grid.appendChild(b);});panel.appendChild(grid);toggle.addEventListener('click',function(){var open=toggle.getAttribute('data-open')==='1';if(open){panel.style.display='none';toggle.setAttribute('data-open','0');}else{panel.style.display='block';toggle.setAttribute('data-open','1');cont.scrollTop=cont.scrollHeight;}});box.appendChild(toggle);box.appendChild(panel);if(cont.firstChild)cont.insertBefore(box,cont.firstChild);else cont.appendChild(box);}
