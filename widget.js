...
function rvVitrine(){var A=[{i:'\U0001F4F8',l:'Revisar foto de mi plato',f:true,m:'Quiero que revises una foto de mi plato.'},{i:'\U0001F4DF',l:'Leer mi gluc\u00f3metro',f:true,m:'Quiero mostrarte la foto de mi gluc\u00f3metro o decirte mi n\u00famero.'},{i:'\U0001F9FE',l:'Revisar una etiqueta',f:true,m:'Quiero que revises la etiqueta de un producto.'},{i:'\U0001F6D2',l:'Comer sano con poco dinero',f:false,m:'Quiero comer sano pero no me alcanza mucho. Ay\u00fadame con algo barato.'},{i:'\U0001F9B6',l:'Revisar un s\u00edntoma',f:false,m:'Quiero contarte un s\u00edntoma que estoy sintiendo.'},{i:'\U0001F9E0',l:'Calmarme cuando tengo miedo',f:false,m:'Tengo miedo y quiero que me ayudes a calmarme.'},{i:'\U0001F469\u200D\u2695\uFE0F',l:'Preparar mi consulta',f:false,m:'Ay\u00fadame a preparar mis dudas para mi pr\u00f3xima consulta m\u00e9dica.'},{i:'\U0001F331',l:'Recordar mi avance',f:false,m:'Quiero recordar lo que ya hice y ver mi avance.'}];function q(){var v=document.getElementById('lw-vitrine');if(v&&v.parentNode)v.parentNode.removeChild(v);}function disp(a){var inp=document.getElementById('lw-input');if(!inp)return;q();inp.value=a.m;if(typeof enviar==='function')enviar();if(a.f){setTimeout(function(){var x=document.getElementById('lw-btn-anexo');if(x)x.click();},700);}}var cont=document.getElementById('lw-msgs');if(!cont||document.getElementById('lw-vitrine'))return;var box=document.createElement('div');box.id='lw-vitrine';box.style.cssText='margin:14px 0 6px;padding:0 4px;';var ti=document.createElement('div');ti.textContent='Luc\u00eda puede ayudarte de formas que un PDF no puede. Elige una opci\u00f3n o escr\u00edbeme con tus palabras.';ti.style.cssText='font-size:13px;line-height:1.5;color:#6b5642;text-align:center;margin:0 6px 12px;font-style:italic;';box.appendChild(ti);var grid=document.createElement('div');grid.style.cssText='display:grid;grid-template-columns:1fr 1fr;gap:8px;';A.forEach(function(a){var b=document.createElement('button');b.type='button';b.style.cssText='display:flex;align-items:center;gap:8px;text-align:left;background:#fbf7ef;border:1px solid rgba(168,130,62,.35);border-radius:12px;padding:11px 12px;font-family:inherit;font-size:12.5px;font-weight:600;color:#2b1810;cursor:pointer;line-height:1.25;';var s1=document.createElement('span');s1.style.cssText='font-size:17px;flex-shrink:0;';s1.textContent=a.i;var s2=document.createElement('span');s2.textContent=a.l;b.appendChild(s1);b.appendChild(s2);b.addEventListener('click',function(){disp(a);});grid.appendChild(b);});box.appendChild(grid);cont.appendChild(box);cont.scrollTop=cont.scrollHeight;}
function rvVitrineEsperar(){var n=0;var iv=setInterval(function(){n++;if(n>60){clearInterval(iv);return;}var c=document.getElementById('lw-chat');var m=document.getElementById('lw-msgs');if(c&&c.style.display!=='none'&&m){clearInterval(iv);setTimeout(rvVitrine,600);}},400);}
