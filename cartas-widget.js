...
(function () {
  ...
  // ---- ESTILOS ----------------------------------------------
  var CSS = ""
    + "@import url('https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,500;0,600;1,400&family=Playfair+Display:ital,wght@1,500;1,600&display=swap');"
    ...
    + "#rv-cp .rv-cp-tit{font-family:'Playfair Display',Georgia,serif;font-style:italic;font-weight:500;font-size:24px;color:#2B1810;margin:8px 0 8px;}"
    + "#rv-cp .rv-cp-sub{font-family:'Lora',Georgia,serif;font-weight:400;font-size:15px;line-height:1.55;color:#5b4636;margin-bottom:18px;}"
    ...
    + "#rv-cp-modal h3{font-family:'Playfair Display',Georgia,serif;font-style:italic;font-weight:500;font-size:22px;color:#2B1810;margin:0 0 4px;}"
    + "#rv-cp-modal label{display:block;font-family:'Lora',Georgia,serif;font-size:13px;font-weight:600;color:#5b4636;margin:14px 0 5px;}"
